		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text"><a href="manage-users.php">
								<h3>User</h3>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text"><a href="manage-bookings.php">
								<h3>Bookings</h3>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text"><a href="manage-enquires.php">
								<h3>Enquiries</h3>
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text"><a href="manage-packages.php">
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text"><a href="manageissues.php">
